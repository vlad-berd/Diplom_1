...
expected_value_get_price_with_one_bun_and_one_filling = (bun_data['price'] + ingredient_filling_data['price'])

excepted_value_get_receipt_only_with_one_bun = (f'(==== {bun_data['name']} ====)\n'
                        f'(==== {bun_data['name']} ====)\n'
                        f'\n'
                        f'Price: {bun_data['price']}')
...
excepted_value_get_receipt_with_bun_and_one_filling = (f'(==== {bun_data['name']} ====)\n'
                        ...
                        f'(==== {bun_data['name']} ====)\n'
                        f'\n'
                        f'Price: {bun_data['price'] + ingredient_filling_data['price']}')
...
excepted_value_get_receipt_with_bun_and_one_sauce = (f'(==== {bun_data['name']} ====)\n'
                        ...
                        f'(==== {bun_data['name']} ====)\n'
                        f'\n'
                        f'Price: {bun_data['price'] + ingredient_sauce_data['price']}')
